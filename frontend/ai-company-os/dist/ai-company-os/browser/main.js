...
function AppComponent_Conditional_36_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AppComponent_Conditional_36_For_2_Template_button_click_5_listener() {
      const alert_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.dismissAlert(alert_r2.id));
    });
    \u0275\u0275text(6, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", alert_r2.message, " ");
  }
}
function AppComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275repeaterCreate(1, AppComponent_Conditional_36_For_2_Template, 7, 2, "div", 15, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var AppComponent = class _AppComponent {
  ...
  showAlert(title, message) {
    ...
    setTimeout(() => this.dismissAlert(id), 6e3);
  }
  dismissAlert(id) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 37, vars: 2, consts: [[1, "layout"], [1, "sidebar"], [1, "sidebar-logo"], [1, "sidebar-nav"], ["routerLink", "/dashboard", "routerLinkActive", "active", 1, "nav-item"], [1, "nav-icon"], ["routerLink", "/projects", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/tasks", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/resources", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/requirements", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/agents", "routerLinkActive", "active", 1, "nav-item"], [1, "sidebar-status"], [1, "status-dot"], [1, "main"], [2, "position", "fixed", "top", "16px", "right", "16px", "display", "flex", "flex-direction", "column", "gap", "8px", "z-index", "9999", "max-width", "340px"], [1, "alert", "alert-warn", 2, "position", "relative", "padding-right", "32px"], [2, "position", "absolute", "top", "8px", "right", "10px", "background", "none", "border", "none", "color", "inherit", "cursor", "pointer", "font-size", "16px", 3, "click"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "aside", 1)(2, "div", 2);
        \u0275\u0275text(3, " AI Company OS ");
        \u0275\u0275elementStart(4, "span");
        \u0275\u0275text(5, "Multi-Agent Platform");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(6, "nav", 3)(7, "a", 4)(8, "span", 5);
        \u0275\u0275text(9, "\u25C8");
        \u0275\u0275elementEnd();
        \u0275\u0275text(10, " Dashboard ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "a", 6)(12, "span", 5);
        \u0275\u0275text(13, "\u25A4");
        \u0275\u0275elementEnd();
        \u0275\u0275text(14, " Projects ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "a", 7)(16, "span", 5);
        \u0275\u0275text(17, "\u2726");
        \u0275\u0275elementEnd();
        \u0275\u0275text(18, " Tasks ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(19, "a", 8)(20, "span", 5);
        \u0275\u0275text(21, "\u25CE");
        \u0275\u0275elementEnd();
        \u0275\u0275text(22, " Resources ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(23, "a", 9)(24, "span", 5);
        \u0275\u0275text(25, "\u229E");
        \u0275\u0275elementEnd();
        \u0275\u0275text(26, " Requirements ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(27, "a", 10)(28, "span", 5);
        \u0275\u0275text(29, "\u2B21");
        \u0275\u0275elementEnd();
        \u0275\u0275text(30, " Agent Monitor ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "div", 11);
        \u0275\u0275element(32, "span", 12);
        \u0275\u0275text(33);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(34, "main", 13);
        \u0275\u0275element(35, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(36, AppComponent_Conditional_36_Template, 3, 0, "div", 14);
      }
      if (rf & 2) {
        \u0275\u0275advance(33);
        \u0275\u0275textInterpolate1(" ", ctx.signalr.isConnected ? "Live \u2014 agents active" : "Connecting...", " ");
        \u0275\u0275advance(3);
        \u0275\u0275conditional(36, ctx.alerts.length > 0 ? 36 : -1);
      }
    }, dependencies: [RouterOutlet, RouterLink, RouterLinkActive, CommonModule], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "src\\app\\app.component.ts", lineNumber: 58 });
})();
...
var routes = [
  ...
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-J4HHJZ47.js").then((m) => m.DashboardComponent)
  },
  {
    path: "projects",
    loadComponent: () => import("./chunk-B5UJEU4M.js").then((m) => m.ProjectsComponent)
  },
  {
    path: "projects/:id/board",
    loadComponent: () => import("./chunk-XHTLCYZR.js").then((m) => m.TasksComponent)
  },
  {
    path: "projects/:id/analyze",
    loadComponent: () => import("./chunk-ZXMD6IVF.js").then((m) => m.ProjectAnalyzeComponent)
  },
  {
    path: "tasks",
    loadComponent: () => import("./chunk-XHTLCYZR.js").then((m) => m.TasksComponent)
  ...
  {
    path: "resources",
    loadComponent: () => import("./chunk-RMEW4RUG.js").then((m) => m.ResourcesComponent)
  },
  {
    path: "agents",
    loadComponent: () => import("./chunk-XFZNJK5O.js").then((m) => m.AgentsComponent)
  },
  {
    path: "requirements",
    loadComponent: () => import("./chunk-AZUISSBR.js").then((m) => m.RequirementsComponent)
  },
