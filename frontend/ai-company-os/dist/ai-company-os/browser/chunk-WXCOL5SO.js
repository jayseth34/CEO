...
var SignalrService = class _SignalrService {
  ...
  connect() {
    return __async(this, null, function* () {
      this.connection = new HubConnectionBuilder().withUrl(environment.hubUrl).withAutomaticReconnect().configureLogging(LogLevel.Warning).build();
  ...
  joinProject(projectId) {
    return __async(this, null, function* () {
      if (this.connection && this.isConnected)
        yield this.connection.invoke("JoinProject", projectId);
    });
  }
  disconnect() {
    return __async(this, null, function* () {
...
//# sourceMappingURL=chunk-WXCOL5SO.js.map
